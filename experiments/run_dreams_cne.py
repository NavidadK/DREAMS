...
for k, (data, labels, init, init_weights, name) in enumerate(zip(data_list, labels_list, init_list, init_weights_list, names_list)):
    ...
    for seed in range(number_rs):
        ...
        for i, l in enumerate(lambdas_list):
            ...
            embedder = cne._cne.CNE(seed=i, negative_samples=5, regularizer=True, reg_embedding=init, reg_lambda=l, reg_scaling='norm', n_epochs=20)
            ...
            # Decoder
            embedder_dec = cne._cne.CNE(seed=i, negative_samples=5, decoder=True, reg_lambda=l, n_epochs=20)
